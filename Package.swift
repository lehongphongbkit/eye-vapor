...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/vapor/sockets.git", .upToNextMajor(from: "2.2.1")),
    ...
    targets: [
        .target(name: "App", dependencies: ["Vapor","MySQLProvider", "FluentProvider", "AdminPanel", "LeafProvider", "VaporAPNS", "Sockets", "S3", "ValidationProvider"],
                exclude: [
                    "Config",
                    "Public",
                    "Resources",
